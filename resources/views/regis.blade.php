...
<head>
    ...
    border: 1px solid black; /* Garis luar putih */
    color: black;
    transition: 0.3s;
}
...
<body>
    <div class="container-fluid">
        <form class="form-login d-flex flex-column gap-2" action="{{ route('proses-regis') }}" method="post" enctype="multipart/form-data">
            @csrf
            <h3 class="fw-normal text-center">Daftar Akun</h3>
            <!-- Nama -->
            <input type="text" class="form-control mb-2" id="nama" placeholder="Username" name="username"equired>
            <!-- Email -->
            ...
            <div class="input-group">
                <input type="password" class="form-control" id="confirm-password" name="password_confirmation" placeholder="Konfirmasi Password"
                    required>
