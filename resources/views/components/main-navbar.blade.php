<nav class="bg-white border-y border-black dark:bg-white mt-5 sticky top-0 w-full z-10 nav-margin shadow-lg">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
        <a href="/news" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-2xl font-bold whitespace-nowrap dark:text-black lg:text-4xl">Diversi-TI</span>
        </a>
        <button data-collapse-toggle="navbar-default" type="button"
            class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-black dark:hover:bg-white dark:focus:ring-black"
